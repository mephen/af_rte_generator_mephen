...
extern Std_ReturnType errorFlag_Rte_Result_Port1_IntraPartitionAsynchronousAdd_Blocking;
...
TASK(T03)
{
    ...
    errorFlag_Rte_Result_Port1_IntraPartitionAsynchronousAdd_Blocking = RTE_E_TIMEOUT;
    TerminateTask();
}
