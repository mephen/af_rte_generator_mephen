...
Std_ReturnType Rte_Call_Port1_IntraPartitionAsynchronousAdd(Impl_uint16 data_1, Impl_uint16 data_2){
    ...
    if(rte_error_code == RTE_E_OK){
        ...
        Rte_Call_Port1_IntraPartitionAsynchronousAdd_metaData.transaction_handle.sequence_counter++;//means rte_call is finished successfully
    }
...
Std_ReturnType Rte_Call_Port1_IntraPartitionSynchronousAdd(Impl_uint16 data_1, Impl_uint16 data_2, Impl_uint16* response){
    ...
    if(rte_error_code == RTE_E_OK){
        ...
        Rte_Call_Port1_IntraPartitionSynchronousAdd_metaData.transaction_handle.sequence_counter++;//means rte_call is finished successfully
    }
    if(Enqueue_rte_call_RB == 1){
...
Impl_uint16 Rte_Client_Runnable_1(){
    ...
    Std_ReturnType rte_error_code = Rte_Call_Port1_IntraPartitionSynchronousAdd(data_1, data_2, &response);
