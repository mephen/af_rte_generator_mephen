...
// extern Std_ReturnType errorFlag_Rte_Result_Port1_IntraPartitionAsynchronousAdd_NonBlocking;
...
//     //rte_result get server response by dequeuing the rte_response_buffer.
//     Impl_uint16 server_response = Rte_Client_ResponseRunnable_1(previous_RteCall_returnValue);
//     if(server_response == 10U){
...
//     previous_RteCall_returnValue = Rte_Client_Runnable_1();
...
//     errorFlag_Rte_Result_Port1_IntraPartitionAsynchronousAdd_NonBlocking = RTE_E_TIMEOUT;
//     TerminateTask();
// }
