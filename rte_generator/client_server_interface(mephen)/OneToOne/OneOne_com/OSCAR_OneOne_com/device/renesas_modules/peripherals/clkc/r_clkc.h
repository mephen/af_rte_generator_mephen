...
#define R_CLKC_RLIN_DISABLE         0x00
#define R_CLKC_RLIN_CPUCLK2         0x01
#define R_CLKC_RLIN_MOSC            0x02
#define R_CLKC_RLIN_PPLLCLK2        0x03
...
void R_CLKC_SetRlinClockDomain(uint32 RlinClockDomain);
