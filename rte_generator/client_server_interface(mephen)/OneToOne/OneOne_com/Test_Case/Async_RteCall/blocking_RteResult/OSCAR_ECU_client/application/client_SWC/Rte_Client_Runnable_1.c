...
Std_ReturnType Rte_Call_Port1_InterEcuAsynchronousAdd(Impl_uint16 data_1, Impl_uint16 data_2){
    ...
    if(rte_error_code == RTE_E_OK || rte_error_code == RTE_E_SOFT_TRANSFORMER_ERROR){
        Rte_Call_Port1_InterEcuSynchronousAdd_metaData.transaction_handle.sequence_counter++;//means rte_call is finished successfully
    }
...
Std_ReturnType Rte_Client_Runnable_1(){
    ...
    Std_ReturnType rte_error_code = Rte_Call_Port1_InterEcuAsynchronousAdd(data_1, data_2);
    return rte_error_code;
}