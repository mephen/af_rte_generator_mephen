...
extern Std_ReturnType errorFlag_Rte_Result_Port1_InterEcuAsynchronousAdd_NonBlocking;
...
void comCase_client_side(){
    ...
    uint8 com_error_code = Com_ReceiveSignal(0U, &(signal)errorFlag_Rte_Result_Port1_InterEcuAsynchronousAdd_NonBlocking);
...
TASK(T02)
{
    ...
    //will be blocked by Rte event
    Impl_uint16 response =  Rte_Client_ResponseRunnable_1(Async_rteCall_returnValue);
