...
Std_ReturnType errorFlag_Rte_Result_Port1_InterEcuAsynchronousAdd_NonBlocking;
...
void comCase_server_side(){
    ...
    signal error_flag = (signal)errorFlag_Rte_Result_Port1_InterEcuAsynchronousAdd_NonBlocking;
