...
FUNC(void, AUTOMATIC) RTE_RUNNABLE_Client4();

/********************************************/
//make sure only Rte_Client_Runnable_4.c can invoke these functions.
#ifdef RTE_CLIENT_RUNNABLE_4_C
/*inter-ECU*/
Std_ReturnType Rte_Call_Port1_AsyncComDivide(Impl_uint16, Impl_uint16);
Std_ReturnType Rte_Call_Port1_SyncComDivide(Impl_uint16, Impl_uint16, Impl_uint16*);
#endif
/********************************************/
