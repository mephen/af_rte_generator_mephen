...
// extern uint8 lock_buffer_x;
// extern uint8 lock_bit_x;
// extern Std_ReturnType errorFlag_Rte_Call_Port1_InterPartitionSynchronousAdd;
...
//     check_RTE_E_TRANSFORMER_LIMIT(&transformer_RB_ioc_2, &errorFlag_Rte_Call_Port1_InterPartitionSynchronousAdd);
...
//     check_RTE_TRANSFORMER_ERROR(&transformer_RB_ioc_2, transformer_error_code, &errorFlag_Rte_Call_Port1_InterPartitionSynchronousAdd);
...
//     /*transform server response to the data_type for ioc_send*/
//     check_RTE_E_TRANSFORMER_LIMIT(&transformer_RB_ioc_2, &errorFlag_Rte_Call_Port1_InterPartitionSynchronousAdd);
...
//     ioc_error_code = IocSend_aa(server_response_transformed);
//     return;
// }
...
//     // uint8* data1 = &foo;
//     // uint8* data2 = &foo2;
//     // StatusType error = IocReceive_aa(data1);
//     // error = IocReceive_aa(data2);
//     // if(*data1 == 6 && *data2 == 3){
//     //     PrintText("ioc receive success\r\n");
//     // }
...
//     RTE_Dequeue(&Rte_request_RB, (void*)&transaction_handle, sizeof(Rte_Cs_TransactionHandleType));
