...
FUNC(Rte_Cs_TransactionHandleType, AUTOMATIC) Rte_Client_Runnable_1();
...
uint8 Xfrm_Inv_transformer_ioc(const Rte_Cs_TransactionHandleType* TransactionHandle, RingBuffer* buffer, uint32* bufferLength, uint8 data);
...
uint8 Xfrm_Inv_transformer_2_ioc(const Rte_Cs_TransactionHandleType* TransactionHandle, RingBuffer* buffer, uint32* bufferLength, uint8 data_1);
