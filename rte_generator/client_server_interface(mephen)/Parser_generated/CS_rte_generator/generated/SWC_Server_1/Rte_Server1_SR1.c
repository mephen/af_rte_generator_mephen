...
Impl_uint16 Add_ImplUint16_Server1_SR1(){
    ...
    RTE_Dequeue(&RB_request_Server1_SR1, &data_1, sizeof(Impl_uint16));
    RTE_Dequeue(&RB_request_Server1_SR1, &data_2, sizeof(Impl_uint16));
    return data_1 + data_2;
}

Impl_uint16 RTE_RUNNABLE_Server1_SR1(){
