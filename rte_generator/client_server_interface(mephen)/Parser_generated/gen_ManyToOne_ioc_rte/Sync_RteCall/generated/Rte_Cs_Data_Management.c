...
//sync+not_used_rte_result
    {.CR_RVuint16 = Client_1, .SR_RVuint16 = Server1_SR1, .client_id = 1, .RB_request_ptr = &RB_request_Server1_SR1, .RB_response_ptr = &RB_response_Client_1, .rte_call_property = sync, .rte_result_property = not_used},
    {.CR_RVuint16 = Client_2, .SR_RVuint16 = Server1_SR1, .client_id = 2, .RB_request_ptr = &RB_request_Server1_SR1, .RB_response_ptr = &RB_response_Client_2, .rte_call_property = sync, .rte_result_property = not_used},
    {.CR_RVuint16 = Client_3, .SR_RVuint16 = Server2_SR1, .client_id = 3, .RB_request_ptr = &RB_request_Server2_SR1, .RB_response_ptr = &RB_response_Client_3, .rte_call_property = sync, .rte_result_property = not_used},
};
