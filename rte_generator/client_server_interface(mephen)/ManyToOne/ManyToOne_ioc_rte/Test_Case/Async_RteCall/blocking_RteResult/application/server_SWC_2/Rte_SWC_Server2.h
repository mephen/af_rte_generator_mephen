...
#include "Rte_SWC_Server2_Type.h"
#include "../ringbuffer.h"

extern RingBuffer RB_request_SWC_Server2_SR1; //each server runnable has its own request buffer
FUNC(Impl_uint16, AUTOMATIC) RTE_RUNNABLE_SWC_Server1_Runnable_1();
