...
Rte_Cs_metaData rte_cs_metaData_arr[3] = {
    //async + non_blocking
    {.CR_RVuint16 = RTE_RUNNABLE_Client1, .CRR_RVuint16 = RTE_RUNNABLE_ClientResponse1, .SR_RVuint16 = RTE_RUNNABLE_Server1, .client_id = 1, .RB_request_ptr = &RB_request_SR1, .RB_response_ptr = &RB_response_CRR1, .async_return_ev = &AsynchronousServerCallReturnsEvent_1, .SR_task = 0x00000002, .CRR_task = 0x00000002, .rte_call_property = async, .rte_result_property = non_blocking},
    {.CR_RVuint16 = RTE_RUNNABLE_Client2, .CRR_RVuint16 = RTE_RUNNABLE_ClientResponse2, .SR_RVuint16 = RTE_RUNNABLE_Server1, .client_id = 2, .RB_request_ptr = &RB_request_SR1, .RB_response_ptr = &RB_response_CRR2, .async_return_ev = &AsynchronousServerCallReturnsEvent_2, .SR_task = 0x00000002, .CRR_task = 0x00000002, .rte_call_property = async, .rte_result_property = non_blocking},
    {.CR_RVuint16 = RTE_RUNNABLE_Client3, .CRR_RVuint16 = RTE_RUNNABLE_ClientResponse3, .SR_RVuint16 = RTE_RUNNABLE_Server3, .client_id = 3, .RB_request_ptr = &RB_request_SR3, .RB_response_ptr = &RB_response_CRR3, .async_return_ev = &AsynchronousServerCallReturnsEvent_3, .SR_task = 0x00010001, .CRR_task = 0x00000002, .rte_call_property = async, .rte_result_property = non_blocking},
    //async + blocking
    // {.CR_RVuint16 = RTE_RUNNABLE_Client1, .CRR_RVuint16 = RTE_RUNNABLE_ClientResponse1, .SR_RVuint16 = RTE_RUNNABLE_Server1, .client_id = 1, .RB_request_ptr = &RB_request_SR1, .RB_response_ptr = &RB_response_CRR1, .async_return_ev = &AsynchronousServerCallReturnsEvent_1, .SR_task = 0x00000002, .CRR_task = 0x00000002, .rte_call_property = async, .rte_result_property = blocking},
    // {.CR_RVuint16 = RTE_RUNNABLE_Client2, .CRR_RVuint16 = RTE_RUNNABLE_ClientResponse2, .SR_RVuint16 = RTE_RUNNABLE_Server1, .client_id = 2, .RB_request_ptr = &RB_request_SR1, .RB_response_ptr = &RB_response_CRR2, .async_return_ev = &AsynchronousServerCallReturnsEvent_2, .SR_task = 0x00000002, .CRR_task = 0x00000002, .rte_call_property = async, .rte_result_property = blocking},
    // {.CR_RVuint16 = RTE_RUNNABLE_Client3, .CRR_RVuint16 = RTE_RUNNABLE_ClientResponse3, .SR_RVuint16 = RTE_RUNNABLE_Server3, .client_id = 3, .RB_request_ptr = &RB_request_SR3, .RB_response_ptr = &RB_response_CRR3, .async_return_ev = &AsynchronousServerCallReturnsEvent_3, .SR_task = 0x00010001, .CRR_task = 0x00000002, .rte_call_property = async, .rte_result_property = blocking},
