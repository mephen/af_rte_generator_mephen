...
extern RteEvent* rte_event_t11[2];
...
#define AsynchronousServerCallReturnsEvent_1_t02 0
#define AsynchronousServerCallReturnsEvent_2_t02 1

//task T11
extern RteEvent OperationInvokedEvent_1;
extern RteEvent OperationInvokedEvent_2;
#define OperationInvokedEvent_1_t11 0
#define OperationInvokedEvent_2_t11 1
