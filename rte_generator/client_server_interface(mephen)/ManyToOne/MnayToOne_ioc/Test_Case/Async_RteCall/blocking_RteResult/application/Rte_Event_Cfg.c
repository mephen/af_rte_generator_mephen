...
RteEventStatus* rte_event_t01[4] = {
...
RteEventStatus* rte_event_t03[4] = {
...
RteEventStatus OperationInvokedEvent_4 = {0,0,0};
RteEventStatus* rte_event_t11[2] = {
    /*OperationInvokedEvent_3_t11*/
    &OperationInvokedEvent_3,
    /*OperationInvokedEvent_4_t11*/
    &OperationInvokedEvent_4
};