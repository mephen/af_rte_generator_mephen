...
extern MemProtAreaType MemProtArea_A01[2];
extern MemProtAreaType MemProtArea_A02[2];
extern MemProtAreaType MemProtArea_A03[2];
extern MemProtAreaType MemProtArea_A04[2];
