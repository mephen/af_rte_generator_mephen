#arxml generator
#-----------------------------------------------------------------------------------------
#此檔案配置是 async Rte_call + blocking Rte_Result case。(因為有配置 waitPoint 引用 AsynchronousServerCallReturnsEvent)
#(inter-Ecu, inter-partition, intra-partition 要從 application_Rte_ecuc.arxml 的 rteEventToTaskMapping 來看)
import os, sys
import pdb
...
AsySerCallRetEv_3.set_eventSource(SWC_Client_IntBehav_CRR3_AsynSerCallResPoint1)
