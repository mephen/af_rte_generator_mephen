...
extern uint8 buffer_Q3[30];
extern ReceiverType receiver_Q3[1] ;
Std_ReturnType IocSend_Q3_SND(uint8);
Std_ReturnType SysIocSend_Q3_SND(uint8);
Std_ReturnType IocReceive_Q3_RCV(uint8*);
Std_ReturnType SysIocReceive_Q3_RCV(uint8*);
