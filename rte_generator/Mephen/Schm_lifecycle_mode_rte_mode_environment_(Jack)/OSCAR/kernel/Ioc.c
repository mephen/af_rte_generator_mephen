...
Std_ReturnType IOC_API(int id, void *input_data, int flag)
{
    ...
    case Q3:
    {
        ...
        {
            return SysIocSend_Q3_SND(d-> data_1);
        }
        if (flag == IOC_RECEIVER_Q3_RCV1)
        {
            return SysIocReceive_Q3_RCV(d-> data_1_r);
        }
...
IocAutosarType Ioc_channel_sender[IOCID_COUNT] = {
    ...
    0 | (1 << app_lion) | (1 << app2) | (1 << app3) | (1 << app4),
    0 | (1 << app_lion) | (1 << app2) | (1 << app3) | (1 << app4), //for sender who call IocSend_Q3_SND
};

IocAutosarType Ioc_channel_receiver[IOCID_COUNT] = {
    0 | (1 << app_lion) | (1 << app2) | (1 << app3) | (1 << app4),
    0 | (1 << app_lion) | (1 << app2) | (1 << app3) | (1 << app4),
    0 | (1 << app_lion) | (1 << app2) | (1 << app3) | (1 << app4), //for receiver who call IocReceive_Q3_RCV
};
...
#define OS_OSAPP_app_lion_START_SEC_CODE
#include "OS_MemMap.h"
Std_ReturnType IocSend_Q3_SND(MyUint16OfVendorID data_1)
{
...
Std_ReturnType SysIocSend_Q3_SND(MyUint16OfVendorID data_1)
{
    Std_ReturnType ret = IOC_E_OK;
...
#define OS_OSAPP_app2_START_SEC_CODE
#include "OS_MemMap.h"
Std_ReturnType IocReceive_Q3_RCV(MyUint16OfVendorID *data_1)
{
    struct IOC_Q3_struct d;
    d.data_1_r = data_1;
    SysServiceParaType para;
...
#define OS_OSAPP_app2_STOP_SEC_CODE
#include "OS_MemMap.h"
Std_ReturnType SysIocReceive_Q3_RCV(MyUint16OfVendorID *data_1)
{
    Std_ReturnType ret = IOC_E_OK;
