...
// for core0
// for core1
TimingEventInfo EV_timing1= {
    .event_ptr = &BswTimingEvent_EV_timing1,
    .event_func_ptr = NULL,
    .event_task = NULL,
    .period_multiple = 2
};

TimingEventInfo EV_timing2= {
    .event_ptr = &BswTimingEvent_EV_timing2,
    .event_func_ptr = NULL,
    .event_task = NULL,
    .period_multiple = 3
};

TimingEventInfo RteEV_timing1= {
    .event_ptr = &RteTimingEvent_RteEV_timing1,
    .event_func_ptr = NULL,
    .event_task = NULL,
    .period_multiple = 2
};

#define TimingEventCore0_ArraySize 2
TimingEventInfo *TimingEventCore0[TimingEventCore0_ArraySize] = {&EV_timing1, &RteEV_timing1};
...
#define TimingEventCore1_ArraySize 1
TimingEventInfo *TimingEventCore1[TimingEventCore1_ArraySize] = {&EV_timing2};
