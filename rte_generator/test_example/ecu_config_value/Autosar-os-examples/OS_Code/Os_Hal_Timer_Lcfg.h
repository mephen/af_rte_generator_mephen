...
extern CONST(Os_Hal_TimerPitConfigType, OS_CONST) OsCfg_Hal_TimerPit_OsCounter_10ms;

/*! HAL timer configuration data: OsCounter_1ms */
extern CONST(Os_Hal_TimerPitConfigType, OS_CONST) OsCfg_Hal_TimerPit_OsCounter_1ms;
