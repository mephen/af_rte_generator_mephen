...
OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Isr_Level1_Dyn, OS_CFG_SIZE_OSCORE0_ISR_LEVEL1_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio1001_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO1001_STACK);
...
/* User: [MyTask] */
OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio13_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO13_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_ApplInitDeInit_Dyn, OS_CFG_SIZE_OSTASK_APPLINITDEINIT_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_ApplMainFunctions_Dyn, OS_CFG_SIZE_OSTASK_APPLMAINFUNCTIONS_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_ApplTimedInitDeInit_Dyn, OS_CFG_SIZE_OSTASK_APPLTIMEDINITDEINIT_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_ApplVerify_Dyn, OS_CFG_SIZE_OSTASK_APPLVERIFY_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_BswMainFunctions_Dyn, OS_CFG_SIZE_OSTASK_BSWMAINFUNCTIONS_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_Communication_Dyn, OS_CFG_SIZE_OSTASK_COMMUNICATION_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_DcmSessionChanges_Dyn, OS_CFG_SIZE_OSTASK_DCMSESSIONCHANGES_STACK);
...
/* User: [OsTask_Dimming] */
OS_STACK_DECLARE(OsCfg_Stack_OsTask_Dimming_Dyn, OS_CFG_SIZE_OSTASK_DIMMING_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_NvmAccess_Dyn, OS_CFG_SIZE_OSTASK_NVMACCESS_STACK);
...
OS_STACK_DECLARE(OsCfg_Stack_OsTask_SelfDiagnostics_Dyn, OS_CFG_SIZE_OSTASK_SELFDIAGNOSTICS_STACK);
...
/* User: [OsTask_Touch] */
OS_STACK_DECLARE(OsCfg_Stack_OsTask_Touch_Dyn, OS_CFG_SIZE_OSTASK_TOUCH_STACK);
...
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Isr_Level1 =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsCore0_Isr_Level1_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsCore0_Isr_Level1_Dyn)
};
...
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio1001 =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsCore0_Task_Prio1001_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsCore0_Task_Prio1001_Dyn)
};

/*! Stack configuration data: OsCore0_Task_Prio13 */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio13 =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsCore0_Task_Prio13_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsCore0_Task_Prio13_Dyn)
};
...
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_ApplInitDeInit =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_ApplInitDeInit_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_ApplInitDeInit_Dyn)
};

/*! Stack configuration data: OsTask_ApplMainFunctions */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_ApplMainFunctions =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_ApplMainFunctions_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_ApplMainFunctions_Dyn)
};

/*! Stack configuration data: OsTask_ApplTimedInitDeInit */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_ApplTimedInitDeInit =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_ApplTimedInitDeInit_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_ApplTimedInitDeInit_Dyn)
};

/*! Stack configuration data: OsTask_ApplVerify */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_ApplVerify =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_ApplVerify_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_ApplVerify_Dyn)
};

/*! Stack configuration data: OsTask_BswMainFunctions */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_BswMainFunctions =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_BswMainFunctions_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_BswMainFunctions_Dyn)
};

/*! Stack configuration data: OsTask_Communication */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_Communication =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_Communication_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_Communication_Dyn)
};

/*! Stack configuration data: OsTask_DcmSessionChanges */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_DcmSessionChanges =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_DcmSessionChanges_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_DcmSessionChanges_Dyn)
};

/*! Stack configuration data: OsTask_Dimming */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_Dimming =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_Dimming_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_Dimming_Dyn)
};

/*! Stack configuration data: OsTask_NvmAccess */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_NvmAccess =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_NvmAccess_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_NvmAccess_Dyn)
};

/*! Stack configuration data: OsTask_SelfDiagnostics */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_SelfDiagnostics =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_SelfDiagnostics_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_SelfDiagnostics_Dyn)
};

/*! Stack configuration data: OsTask_Touch */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_Touch =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_Touch_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_Touch_Dyn)
};
