...
const TaskConstType TaskConst_core0[TASK_OBJECTS_COUNT_CORE0] = {
    ...
    /* Task T01 */
    {
        ...
        1, /* task max activations */
        0 | event2 | event3,
        0 | (1 << (resourceApp1 & 0xffff)), 

        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T01_SEC_data),
            (uint32*)(_ETASK_T01_SEC_data),
            (uint32*)(_STASK_T01_SEC_data_R),
            (uint32*)(_STASK_T01_SEC_bss),
            (uint32*)(_ETASK_T01_SEC_bss)
        }
    },
    /* Task T02 */
    {
        ...
        1, /* task max activations */
        0 | event3,
        0 | (1 << (resource1 & 0xffff)) | (1 << (resourceApp1 & 0xffff)), 

        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T02_SEC_data),
            (uint32*)(_ETASK_T02_SEC_data),
            (uint32*)(_STASK_T02_SEC_data_R),
            (uint32*)(_STASK_T02_SEC_bss),
            (uint32*)(_ETASK_T02_SEC_bss)
        }
    },
    /* Task T03 */
    {
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T03_SEC_data),
            (uint32*)(_ETASK_T03_SEC_data),
            (uint32*)(_STASK_T03_SEC_data_R),
            (uint32*)(_STASK_T03_SEC_bss),
            (uint32*)(_ETASK_T03_SEC_bss)
        }
    },
    /* Task T04 */
    {
        ...
        1, /* task max activations */
        0 | event2 | event3,
        0 | (1 << (resource1 & 0xffff)) | (1 << (resourceApp3 & 0xffff)), 

        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T04_SEC_data),
            (uint32*)(_ETASK_T04_SEC_data),
            (uint32*)(_STASK_T04_SEC_data_R),
            (uint32*)(_STASK_T04_SEC_bss),
            (uint32*)(_ETASK_T04_SEC_bss)
        }
    },
    /* Task T05 */
    {
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T05_SEC_data),
            (uint32*)(_ETASK_T05_SEC_data),
            (uint32*)(_STASK_T05_SEC_data_R),
            (uint32*)(_STASK_T05_SEC_bss),
            (uint32*)(_ETASK_T05_SEC_bss)
        }
    },
    /* Task T06 */
    {
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T06_SEC_data),
            (uint32*)(_ETASK_T06_SEC_data),
            (uint32*)(_STASK_T06_SEC_data_R),
            (uint32*)(_STASK_T06_SEC_bss),
            (uint32*)(_ETASK_T06_SEC_bss)
        }
    },
    /* isr I005 Task */
    {
    ...
    /* Task sysTask */
    {
        ...
        255, /* task max activations */
        0,
        0 | (1 << (resourceApp1 & 0xffff)) | (1 << (resourceApp3 & 0xffff)), 
...
const TaskConstType TaskConst_core1[TASK_OBJECTS_COUNT_CORE1] = {
    ...
    /* Task T11 */
    {
        TASK_ENTRY(T11),            /* task entry point */
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T11_SEC_data),
            (uint32*)(_ETASK_T11_SEC_data),
            (uint32*)(_STASK_T11_SEC_data_R),
            (uint32*)(_STASK_T11_SEC_bss),
            (uint32*)(_ETASK_T11_SEC_bss)
        }
    },
    /* Task T12 */
    {
        TASK_ENTRY(T12),            /* task entry point */
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T12_SEC_data),
            (uint32*)(_ETASK_T12_SEC_data),
            (uint32*)(_STASK_T12_SEC_data_R),
            (uint32*)(_STASK_T12_SEC_bss),
            (uint32*)(_ETASK_T12_SEC_bss)
        }
    },
    /* Task T13 */
    {
        TASK_ENTRY(T13),            /* task entry point */
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T13_SEC_data),
            (uint32*)(_ETASK_T13_SEC_data),
            (uint32*)(_STASK_T13_SEC_data_R),
            (uint32*)(_STASK_T13_SEC_bss),
            (uint32*)(_ETASK_T13_SEC_bss)
        }
    },
    /* Task T14 */
    {
        TASK_ENTRY(T14),            /* task entry point */
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T14_SEC_data),
            (uint32*)(_ETASK_T14_SEC_data),
            (uint32*)(_STASK_T14_SEC_data_R),
            (uint32*)(_STASK_T14_SEC_bss),
            (uint32*)(_ETASK_T14_SEC_bss)
        }
    },
    /* Task T15 */
    {
        TASK_ENTRY(T15),            /* task entry point */
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T15_SEC_data),
            (uint32*)(_ETASK_T15_SEC_data),
            (uint32*)(_STASK_T15_SEC_data_R),
            (uint32*)(_STASK_T15_SEC_bss),
            (uint32*)(_ETASK_T15_SEC_bss)
        }
    },
    /* Task T16 */
    {
        TASK_ENTRY(T16),            /* task entry point */
        ...
        //RomToRamInitTableType RomToRamInitTable
        {
            (uint32*)(_STASK_T16_SEC_data),
            (uint32*)(_ETASK_T16_SEC_data),
            (uint32*)(_STASK_T16_SEC_data_R),
            (uint32*)(_STASK_T16_SEC_bss),
            (uint32*)(_ETASK_T16_SEC_bss)
        }
    },
    /* isr I105 Task */
    {
        ...
        I105 + TASKS_COUNT_CORE0 -1 ,  /* isr2 task id */
        {      /* task const flags */
            0, /* not extended task */
            1, /* preemptive task */
            1  /* isr2 task */
    ...
    /* isr I106 Task */
    {
        ...
        I106 + TASKS_COUNT_CORE0 -1 ,  /* isr2 task id */
        {      /* task const flags */
            0, /* not extended task */
            1, /* preemptive task */
            1  /* isr2 task */
...
TaskVarType TaskVar_core0[TASK_OBJECTS_COUNT_CORE0] = {
    ...
    /* Task T01 */
    {
        ...
        NULL, /* pointer to resources */
        NULL, /* pointer to next task */
        1,    /* the number of activations */
        task_static_prio_T01,
        0,    /* task state */
        NULL,  /* point to the internal resource */
        App1, /* the executing application id */
    ...
    /* Task T03 */
    {
        ...
        NULL, /* pointer to resources */
        NULL, /* pointer to next task */
        10,    /* the number of activations */
        task_static_prio_T03,
        0,    /* task state */
        NULL,  /* point to the internal resource */
        App1, /* the executing application id */
        0, /* nesting trust function count */
...
const TaskType TasksAutoStartAppMode2[TASK_AUTOSTART_AppMode2_COUNT]  = {
   T11,
};
...
const AutoStartType AutoStart[2]  = {
   ...
   /* Application Mode AppMode2 */
    {
        TASK_AUTOSTART_AppMode2_COUNT, /* Total Auto Start Tasks in this Application Mode */
        (TaskRefType)TasksAutoStartAppMode2 /* Pointer to the list of Auto Start Stacks on this Application Mode */
    },
};
