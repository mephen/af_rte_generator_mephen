...
datatype_file = os.path.join(os.path.dirname(__file__), 'swc', 'tpc_composition_datatype.arxml') 

TPC_Composition_ARPackage = autosarfactory.new_file(datatype_file, defaultArPackage = 'TPC_Composition', overWrite = 'true') 
